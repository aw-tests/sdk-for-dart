...
class Health extends Service {
    ...
    Future<models.HealthQueue> getQueueBuilds() async {
    ...
    Future<models.HealthQueue> getQueueDatabases({String? name}) async {
    ...
    Future<models.HealthQueue> getQueueDeletes() async {
    ...
    /// internal queue server.
    Future<models.HealthQueue> getQueueMails() async {
    ...
    /// internal queue server.
    Future<models.HealthQueue> getQueueMessaging() async {
    ...
    /// Appwrite internal queue server.
    Future<models.HealthQueue> getQueueMigrations() async {

...
'name': name,
    ...
    Future<models.User> createSHAUser({required String userId, required String email, required String password, enums.PasswordVersion? passwordVersion, String? name}) async {
